    ...
    <div className="flex justify-center mt-20 select-none">
      <div className="font-nunito w-3/5 shadow-xl rounded-lg border-2 border-gray-200 py-5 px-8 laptop:w-4/5 tablet:w-full mobile:w-full">
        <div className="flex items-center gap-10">
          ...
          <div className="flex flex-col gap-4 tablet:w-4/5">
            <h1 className="text-3xl font-bold capitalize mobile:text-2xl">
              Why trade in Online currencies stock ?
            </h1>
            <p>
              In general, the Online currencies stock market is considered illiquid
            ...
            <p>
            Online currencies stock are what stocks were centuries ago; they are the
              ...
              with around 11 million Indians trading in Online currencies stock. Start
        ...
        <div className="flex items-center gap-10 pb-2 pt-14">
          <div className="flex flex-col gap-4 tablet:w-4/5">
            <h1 className="text-3xl font-bold capitalize mobile:text-2xl">
              Why to use Online currencies stock ?
            </h1>
            <p>
              You can start trading in Online currencies stock as low as RS-100 with
              TP-Coin, Buy, sell and trade 99+ Online currencies stock at the best
              ...
              one-year chart, news, and more about a specific Online currencies stock.
            </p>
            ...
            <p>
              ...
              enable you to trade in Online currencies stock at the best price in
              India.
            </p>
