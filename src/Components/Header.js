    ...
    <div className="select-none relative top-28 px-52 mb-20 bg-gray-200 mobile:px-1 tablet:px-10 laptop:px-32">
      <div className="bg-taj-mahal bg-no-repeat bg-right bg-opacity-0">
        <div className="p-10 font-nunito">
          <p className="text-5xl font-bold my-5">Welcome to online trading app</p>
          <p className="text-lg text-gray-700 mobile:text-base">
            Pakistan leading Online currencies stock Exchange.
          </p>
          <p className="text-lg text-gray-700 mobile:text-base">
            Invest in genuine Online currencies stock in One-Click for a better future.
          </p>
          <div>
            {
            cookies.get("isLogin") ? (
